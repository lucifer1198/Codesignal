...
Note that both operations were possible on all the steps because 501 and 51 are also divisible by 3. 
However, only the listed sequence of operations leads to the smallest possible result.
